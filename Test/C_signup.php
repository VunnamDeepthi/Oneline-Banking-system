...
<?php
    ...
    $sql="INSERT INTO dbo.Customer (Username,Name,Dob,Gender,Address,Password) VALUES('{$Username}','{$Name}','{$Dob}','{$gender}','{$Address}','{$Password}')";
    $sql1="INSERT INTO dbo.C_Number (Username,Number) VALUES('{$Username}','{$Number1}')";
    $sql2="INSERT INTO dbo.C_Number (Username,Number) VALUES('{$Username}','{$Number2}')";
      ...
      <div class="flex-container">
            <div class="flex-item-1">
              <div class="flex-item-login">
                        <h2 style="text-align:center;font-style: italic">Customer Sign-Up </h2>
                    ...
                    <div class="flex-item-login">
                        ...
                        <input style="text-align:center;width:350px;height:35px;" type="text" placeholder="Enter Address" name="Address" >
                    </div>
                    <div class="flex-item-login">
                    ...
                    <div class="flex-item-login">
                        ...
                        <p><a style="color:white;" href="E_signup.php"> Employee Sign up? Sign up</a></p>
                    </div>
        </div>
        </div>
    </div>
